...
namespace Cust.DAL
{
	...
	public partial class operatorDal
	{
		...
		public int Add(Cust.Model.operators model)
		{
			...
			strSql.Append("Name,Pwd)");
			strSql.Append(" values (");
			strSql.Append("SQL2012Name,SQL2012Pwd)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012Name", SqlDbType.VarChar,50),
					new SqlParameter("SQL2012Pwd", SqlDbType.VarChar,50)};
		...
		public Cust.Model.operators GetModel(int Id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,Name,Pwd from operator ");
			strSql.Append(" where Id=SQL2012Id");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012Id", SqlDbType.Int,4)
			};
			...
			Cust.Model.operators model=new Cust.Model.operators();
		...
		/// 得到一个对象实体
		/// </summary>
		public Cust.Model.operators DataRowToModel(DataRow row)
		{
			Cust.Model.operators model=new Cust.Model.operators();
			if (row != null)
			{
