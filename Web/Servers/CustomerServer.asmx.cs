...
namespace Cust.Web
{
    ...
    public class CustomerServer : System.Web.Services.WebService
    {
        ...
        [WebMethod(Description = "Add customer")]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void AddCusto()
        {
            ...
            try
            {
                ...
                int i = oneHelper.Add(new Model.customer() { Name = name, Note = note });

                if (i > 0)
                {
                    tempJson = new { status = 0 };
                }
                else
                {
                    tempJson = new { status = 1 };
                }
        ...
        [WebMethod(Description = "Del customer")]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void DelCusto()
        {
        ...
        [WebMethod(Description = "ShowUpCusto")]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void ShowUpCusto()
        {
            ...
            try
            {
                ...
                Model.customer c = oneHelper.GetModel(id);
        ...
        [WebMethod(Description = "up customer")]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public void UpCusto()
        {
            ...
            try
            {
                ...
                bool i = oneHelper.Update(new Model.customer() {Id=id, Name = name, Note = note });
